...
let s:kanagawa0 = ["#16161d", "NONE"]
let s:kanagawa1 = ["#1f1f28", 0]
let s:kanagawa2 = ["#2a2a37", "NONE"]
let s:kanagawa3 = ["#363646", 8]
...
let g:lightline#colorscheme#kanagawa_dragon#palette = lightline#colorscheme#flatten(s:p)
