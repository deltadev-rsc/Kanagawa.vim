...
let s:kanagawa1_gui  = "#1f1f28" " Main background
let s:kanagawa2_gui  = "#2a2a37" " Lighter background
let s:kanagawa3_gui  = "#363646" " Selection/highlight background
let s:kanagawa4_gui  = "#dcd7ba" " Main foreground
let s:kanagawa5_gui  = "#e6e2c8" " Lighter foreground
let s:kanagawa6_gui  = "#eff1f5" " Brightest foreground
